...
def logo_taekyung():
    try:
        os.system("xdg-open https://youtube.com/channel/UCQdAaMChWP1broOdhr6T84g")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
\033[1;92m
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
<<<<<<>>>>Classy Bastard Cyber<<<<<>>>                                                                           
        |Seamat Mencoba|                                    
        |Open Member Team|                                  
        |info Hubungi Facebook Anissa|                         
        |Jangan lupa Bersyukur|                             
        |Facebook : Anissa Syahputri|                    
\033[1;91m\033[1;41m\033[1;97m Author: By Heyho\033[;0m\033[1;91m\033[1;92m
""")
